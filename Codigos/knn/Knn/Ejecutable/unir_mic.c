...
int main(int argc, char *argv[])
{
	...
	char ruta_fuentes[256] = "usr/lib/knn/Knn/Xeon_Phi/Fuentes/";
	char ruta_menu[256] = "usr/lib/knn/Knn/Xeon_Phi/Menus/";
	...
	if (existe == 1){
		char programa[500];
		sprintf(programa, "icc %s -openmp -lm -o %s", argv[3],argv[4]);
		printf("%s\n",programa );
